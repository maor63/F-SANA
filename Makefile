...
CXXFLAGS = -U__STRICT_ANSI__ -Wall -std=c++1y -O3 #-ggdb -pg -Bstatic #-static


INCLUDES = -I/usr/local/igraph
LFLAGS = -ligraph
...
METHODS_SRC =   							\
	...
	src/methods/SANA_Improved.cpp                                   \
	src/methods/SANA_Abstract.cpp
